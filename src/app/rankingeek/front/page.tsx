...
//     id: 1,
//     title: "Atkins Diet",
//     image: "/atkinsdiet.jpg", // Replace with actual image path
//   },
//   {
//     id: 2,
//     title: "Low Fat Diet",
//     image: "/lowfatdiet.jpg", // Replace with actual image path
//   },
//   {
//     id: 3,
//     title: "Low Carb Diet",
//     image: "/lowcarbdiet.jpg", // Replace with actual image path
//   },
//   {
//     id: 4,
//     title: "Keto Diet",
//     image: "/greenvegetableone.jpg", // Replace with actual image path
//   },
//   {
//     id: 5,
//     title: "Mediterranean Diet",
//     image: "/mediterraneandietone.jpg", // Replace with actual image path
//   },
// ];

// // All 10 diets
// const diets = [
//   { name: "Raw Food Diet", label: "Raw Food Diet", image: "/anythingdiet.png" },
...
//   { name: "dairyfree", label: "dairyfree", image: "/dairyfree.png" },
//  ];
...
//   // State for selected diet, calories, and meals
...
//   // for BMI calculator logic 
//   const [gender, setGender] = useState<"male" | "female">("male");
//   const [isOpen, setIsOpen] = useState(false);
//   // Existing BMI-related states
...
//   // Recalculate the needle angle whenever BMI changes
//   useEffect(() => {
//     const minBMI = 16;
//     const maxBMI = 35;
//     const minAngle = -90;
...
//     // Clamp the bmi value between minBMI and maxBMI
...
//   // Macros for each diet (feel free to adjust)
...
//   // Calculate macros in grams from total calories
...
//     // total macros from total cals
//     const totalCarbs = (cals * ratio.carbs) / 4; // 4 kcal per gram carb
//     const totalFat = (cals * ratio.fat) / 9; // 9 kcal per gram fat
//     const totalProtein = (cals * ratio.protein) / 4; // 4 kcal per gram protein
...
//               {["Create Diet Plan", "Calculator", "Article"].map(
//                 (item, index) => (
//                   <li
//                     key={index}
...
//                   <li
//                     key={index}
//                     className="text-lg text-purple-800 font-semibold hover:text-purple-600 cursor-pointer"
//                   >
//                     {item}
//                   </li>
//                 )
...
//       {/*  Plan a search gym-diet  */}
//       <section>
//         {/* Fullscreen Background with Search */}
...
//           {/* Search Bar (Only visible when list is NOT open) */}
//           {!showList && (
...
//         {/* Destination List Overlay (Appears when input is clicked) */}
//         {showList && (
...
//             {/* Search Bar Inside Destination List */}
...
//       <section 
//        style={{
//        backgroundImage: "url('/backgroundone.jpg')", // Background Image
//        backgroundSize: 'cover', // Ensures the image covers the entire element
//        backgroundPosition: 'center' // Optional: centers the 
...
//           {/* Navigation Buttons (Centered at the Top) */}
...
//               onClick={nextSlide}
//               className={`bg-white p-3 rounded-full shadow-lg hover:bg-gray-200 transition mx-2 ${
//                 startIndex >= dietPlans.length - slidesToShow
...
//       <section  
//       style={{
//         backgroundImage: "url('/backgroundtwo.jpg')", // Background Image
//        backgroundSize: 'cover', // Ensures the image covers the entire element
//        backgroundPosition: 'center' // Optional: centers the 
...
//             {/* Diet Options in a responsive grid */}
...
//             {/* Inputs: Calories and Meals */}
//             <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mb-8">
//               {/* Calories input */}
//               <div className="flex items-center mb-4 sm:mb-0">
//                 <label className="mr-2 font-semibold text-blue-500 font-serif text-[20]">
//                   I want to eat
//                 </label>
//                 <input
//                   type="number"
...
//                 />
//                 <span className="ml-2 text-red-800 font-serif text-[20]">
//                   calories
//                 </span>
//               </div>
...
//                 <label className="mr-2 font-semibold text-black font-serif text-[20]">
//                   in
//                 </label>
//                 <input
//                   type="number"
...
//                 />
//                 <span className="ml-2 text-yellow-900 font-serif text-[20]">
//                   meals
//                 </span>
//               </div>
//             </div>
...
//         style={{
//        backgroundImage: "url('/backgroundfour.jpg')", // Background Image
//        backgroundSize: 'cover', // Ensures the image covers the entire element
//        backgroundPosition: 'center' // Optional: centers the 
...
//           {/* White form container with hover effect */}
//           <div
//             className="w-full max-w-xl bg-white rounded-xl shadow-2xl p-6 sm:p-8 md:p-10 
...
//                 className={`flex flex-col items-center cursor-pointer p-4 rounded-full bg-gray-200
...
//             {/* Form Fields (3 inputs in first row, 1 in second row) */}
//             {/* Row 1: Age, Feet, Inches */}
...
//                   value={feet}
//                   onChange={(e) =>
//                     setFeet(e.target.value === "" ? "" : Number(e.target.value))
//                   }
//                   placeholder="e.g. 5"
//                   className="mt-1 w-full border border-gray-300 rounded px-3 py-2 
//                 focus:outline-none focus:ring-2 focus:ring-purple-400"
...
//                 className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold py-2 px-8 
//               rounded shadow-md transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-300"
//               >
//                 I AM READY TO CHECK THE RESULTS
//               </button>
//             </div>

//             {/* BMI Gauge appears below the form once user calculates */}
...
//         }}
//       />
//       {/* White mask to hide the lower half */}
...
//         <div
//           className="color-box w-4 h-4 sm:w-5 sm:h-5"
...
//       style={{
//         backgroundImage: "url('/backgroundthree.jpg')", // Background Image
//        backgroundSize: 'cover', // Ensures the image covers the entire element
//        backgroundPosition: 'center' // Optional: centers the 
...
//           {/* Success Stories Grid - Single Row */}
//           <div className="mt-8 flex flex-wrap justify-center gap-[30px] md:gap-y-20">
//             {successStories.map((story, index) => (
//               <div
//                 key={index}
//                 className="flex items-center space-x-[5px] md:space-x-1"
//               >
//                 {/* Before Image */}
...
//   style={{
//     backgroundImage: "url('/gym-diet2.jpg')", // Background Image
//   }}
// >
//   {/* Green Wave Divider */}
//   <div className="absolute -top-8 left-0 w-full">
//     <svg
//       className="w-full h-16 fill-[#8dc63f]"
...
//         <img src="/logoone.png" alt="Logo" className="h-[120px] mt-[-30px] md:mx-0" />
//          <p>Gym diet plan</p>
...
const Page = () => {
  ...
  const calculateMacros = (cals: number, mealsCount: number, diet: string) => {
    // Convert diet to lowercase to match our keys.
    const key = diet.toLowerCase();
    const ratio = dietMacros[key];
    if (!ratio) return { carbs: "0", fat: "0", protein: "0" };
  ...
  return (
    <div className="bg-gray-200">
      ...
      >
        <div className="min-h-screen flex items-center justify-center p-4">
          <div
            className="w-full max-w-xl bg-white rounded-xl shadow-2xl p-6 sm:p-8 md:p-10 transition-all duration-300 transform hover:scale-105"
          >
            <h2 className="text-center text-2xl font-bold text-gray-700 mb-6 font-serif">
              Choose gender
            </h2>
            <div className="flex items-center justify-center gap-8 mb-8">
              ...
              >
                <div className="w-24 h-24 rounded-full overflow-hidden">
                  <img src="/male.png" alt="Male" className="w-full h-full object-cover" />
                </div>
                <span className="mt-2 text-lg font-semibold text-gray-700 font-serif">
                  Male
                </span>
              ...
              >
                <div className="w-24 h-24 rounded-full overflow-hidden">
                  <img src="/female.png" alt="Female" className="w-full h-full object-cover" />
                </div>
                <span className="mt-2 text-lg font-semibold text-gray-700 font-serif">
                  Female
                </span>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-[30px] md:gap-y-20">
            {successStories.map((story, index) => (
              <div key={index} className="flex items-center space-x-[5px] md:space-x-1">
                <div className="relative w-26 md:w-48 h-56 md:h-72 overflow-hidden rounded-lg shadow-lg border">
                  <img src={story.before} alt={`Before ${index + 1}`} className="h-full w-full object-fit" />
                </div>
              </div>
            ))}
          </div>
      ...
      >
        ...
        <div className="relative z-10 bg-black bg-opacity-80 py-10 px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center md:text-left">
              <img src="/logoone.png" alt="Health Logo" className="h-[120px] mt-[-30px] md:mx-0" />
              <p>Gym diet plan</p>
              <h3 className="text-2xl font-bold mt-3 text-white">fitmeal</h3>
              <p className="text-gray-300 mt-3 leading-relaxed">
                Integer maximus accumsan nunc, sit amet tempor lectus facilisis eu.
